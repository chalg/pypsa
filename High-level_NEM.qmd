...
Marinus Link Stage 1, which has recently reached Final Investment Decision (FID), is included in all scenarios, including the baseline. If this link is removed, the VIC1 region experiences 14.3 GWh of unserved energy. Examination of the challenging winter snapshot below highlights that a significant portion of this shortfall occurs during that period.

Whether building a very costly interconnector to bridge this gap is a justifiable business case remains open to debate.
