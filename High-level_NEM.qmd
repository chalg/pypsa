...
<div style="text-align: center;">
![Moomba to Adelaide gas pipeline utilisation vs barometric pressure, wind speed and temperature at Port Pirie, South Australia.^[Gif created using `maps_utilisation_animation.py` located under the scripts folder]](images/gas_pipeline_all_weather_animation.gif)
</div>
...
<div style="text-align: center;">
![Gas storage levels at Iona underground storage, near Port Campbell in southwestern Victoria.^[Plot created using `iona_storage_by_year.py` located under the scripts folder]](images/iona_storage_by_year.png)
</div>
