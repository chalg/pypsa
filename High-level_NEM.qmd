...
There is a clear midday **plateau** in utility solar output (orange boxplots), likely resulting from **negative market prices** and/or **network constraints** such as congestion^[For detailed information on solar farm capacity factors and why considering them in isolation can be misleading, see this excellent Wattclarity article [here](https://wattclarity.com.au/articles/2023/03/why-capacity-factor-is-an-increasingly-simplistic-way-to-compare-solar-farm-performance/).
].
