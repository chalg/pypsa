...
format:
  html:
    ...
    output-dir: docs        # doesn't work. Use subprocess script
    theme: cosmo            # theme
...
This reduces gas-powered generation by xx% compared to Open Electricity consumption over a recent 12 month period.
